...
public class DiagramRecorderTest {
	...
	public void testStartRecording() throws Exception {
		...
		String entryPointName = sk.anivit.stacktracegen.recording.Test.class.getName()+":testik";
		String caption = "caption";
		String fileName = "fn";
		String outputDir = "od";
		String diaClasses = sk.anivit.stacktracegen.recording.Test.class.getName();
		DiagramRecorder.startRecording(entryPointName, caption, fileName, outputDir, diaClasses, "label");
		assertEquals(DiagramRecorder.currentDiagramBean.getEntryPoint(),pool.get( sk.anivit.stacktracegen.recording.Test.class.getName()).getDeclaredMethod("testik"));
	...
	public void testMethodCalled() throws Exception {
		...
		String outputDir = "od";
		String diaClasses = sk.anivit.stacktracegen.recording.Test.class.getName();
		DiagramRecorder.startRecording(entryPointName, caption, fileName, outputDir, diaClasses, "");

		DiagramRecorder.methodCalled(sk.anivit.stacktracegen.recording.Test.class.getName()+":testik");
		...
		assertEquals(pool.get(sk.anivit.stacktracegen.recording.Test.class.getName()).getDeclaredMethod("testik"), r.getMethod());
